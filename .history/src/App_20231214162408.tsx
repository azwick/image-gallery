      ...
      <header className="pageHead">
        ...
        <nav className="pageHead-nav">
          <ul className="pageHead-nav-list">
            <li><button onClick={() => setShowHomeView(true)} className={showHomeView ? 'pageHead-nav-list-item active' : 'pageHead-nav-list-item'}>Photos</button></li>
            <li>
                <button onClick={() => setShowHomeView(false)} className={!showHomeView ? 'pageHead-nav-list-item active' : 'pageHead-nav-list-item'}>
                  Favorites List
