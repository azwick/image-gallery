...
const ImageItem = ({ albumId, id, title, url, thumbnailUrl, addToWishList, createFavoritesList }: ImageItemInterface) => {
  ...
  return (
    ...
    <div className="galleryList-item">
      ...
      {/* ------- ONLY Gallery ------- */}
        ...
        <div onClick={() => addToWishList(albumId, id, title, url, thumbnailUrl)} className="addIcon">
          {selectedPhoto ?
