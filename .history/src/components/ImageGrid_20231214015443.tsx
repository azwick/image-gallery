...
const ImageList = ({albumID, createFavoritesList}:ImageListInterface): React.ReactElement => {
      ...
      <>
        <div className="galleryList">
            {photoListData.map((photoList: any) => (
                <ImageItem key={photoList.id} id={photoList.id} albumId={photoList.albumId} title={photoList.title} thumbnailUrl={photoList.thumbnailUrl} url={photoList.url} createFavoritesList={createFavoritesList} />
            ))}
        </div>
        {isSpinning && <Spinner />}
      </>
