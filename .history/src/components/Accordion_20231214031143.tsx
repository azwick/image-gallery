    ...
    return (
      <section className="accordionList">
        {photoAlbumData.map((photoAlbum: PhotoAlbumInterface) => (
            ...
            {/* {openThisGallery ===  photoAlbum.id && */} {/* Change class into: "accordionList-item-content open"*/}
                <div className={open && openThisGallery ===  photoAlbum.id ? "Change class into: "accordionList-item-content open" : "accordionList-item-content"}>
