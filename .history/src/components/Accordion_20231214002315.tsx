...
const Accordion = ({photoAlbumData, isLoading, createWishListData}: AccordionInterface): React.ReactElement => {
        ...
        {photoAlbumData.map((photoAlbum: PhotoAlbumInterface) => (
            ...
            {openThisGallery ===  photoAlbum.id &&
                <div className="accordionList-item-content">
                    <ImageGrid albumID={photoAlbum.id} createWishListData={createWishListData} />
                </div>
            }
            </article>
        ))}
