...
const Accordion = ({photoAlbumData, isLoading, addToWishList, createFavoritesList}: AccordionInterface): React.ReactElement => {
        ...
        {photoAlbumData.map((photoAlbum: PhotoAlbumInterface) => (
            ...
            {/* {openThisGallery ===  photoAlbum.id && */}
                <div className="accordionList-item-content">
                    <ImageGrid albumID={photoAlbum.id} addToWishList={addToWishList} createFavoritesList={createFavoritesList} />
                </div>
            {/* } */}
            </article>
        ))}
