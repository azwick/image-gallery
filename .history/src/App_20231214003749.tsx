...
const App = () => {
  ...
  const [favoritesList, setFavoritesListData] = useState([])
  ...
  return (
    <main className="page">
      ...
      {
        showHomeView ? <GalleryView createFavoritesList={setFavoritesListData} /> : <WishListView favoritesList={favoritesList} />
      }
