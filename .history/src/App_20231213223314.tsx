      ...
      <header className="header">
        ...
        <nav className="header-nav">
          <ul className="header-nav-list">
            <li className="header-nav-list-item" onClick={toggleView}>Home</li>
            <li className="header-nav-list-item" onClick={toggleView}>WishList</li>
          </ul>
        </nav>
      </header>
      {
        showWishlist ? <WishListView /> : <GalleryView />
      }
    </main>
  )
}
